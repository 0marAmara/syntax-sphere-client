export type formFieldStyleType = 'default';

export const FORM_FIELD_TYPES: Record<formFieldStyleType, { label: { normal: string, error: string }, input: { normal: string, error: string } }> = {
  default: {
    label: {
